...
set_or_add_plist_key "$APP_PATH/Contents/Info.plist" "CFBundleName" "T&Tv2.0"
set_or_add_plist_key "$APP_PATH/Contents/Info.plist" "CFBundleDisplayName" "T&Tv2.0"
